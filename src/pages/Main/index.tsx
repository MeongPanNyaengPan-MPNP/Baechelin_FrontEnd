...
function Main() {
  ...
  /*   React.useEffect(() => () => {
      queryClient.invalidateQueries(STORE_LIST.ARROUND_STORE);
      queryClient.invalidateQueries(STORE_LIST.BEST_BOOKMARK_STORE);
      queryClient.invalidateQueries(STORE_LIST.BEST_POINT_STORE);
    } ); */
